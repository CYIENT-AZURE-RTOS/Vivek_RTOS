...
//  tx_mutex_create(&Uart_Mutex,"Uart Mutex",TX_NO_INHERIT);
  tx_semaphore_create(&Uart_Semaphore,"Uart_Semaphore",1);
...
void ThreadOne_Entry(ULONG Thread_in){
	...
	char hw[]="888888888888888888888888888888888888888888888888888888888888888888888888888888\n\r";
	while(1){
//		HAL_GPIO_TogglePin(LED_GREEN_GPIO_Port, LED_GREEN_Pin);
//		HAL_Delay(1000);
//		App_Delay(10);
		if(TX_SUCCESS==tx_semaphore_get(&Uart_Semaphore,TX_NO_WAIT)){
...
void ThreadTwo_Entry(ULONG Thread_in){
    ...
    char hw[]="111111111111111111111111111111111111111111111111111111111111111111111111\n\r";
	while(1){
